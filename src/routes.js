...
const routes = [
  ...
  { path: '/countyList', name: 'Country list', element: CountryList},
  { path: '/country', name: 'Country list', element: Country},
  { path: '/addwebsite', name: 'Add Website', element: AddWebsite},
